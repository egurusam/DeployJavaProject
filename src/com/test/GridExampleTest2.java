...
public class GridExampleTest2 {
	...
	public void testGooglePageTitleInIEBrowser() throws InterruptedException {
		...
		System.out.println("***Click Email Link ****");
		...
		for (String window : winHandles) {
			...
			if(driver.getTitle().equals("Create your Google Account"))
			{
				...
				driver.findElement(By.name("FirstName")).sendKeys("ChromeDriver");
				driver.findElement(By.name("LastName")).sendKeys("WebDriver");
				driver.findElement(By.name("GmailAddress")).clear();
				driver.findElement(By.name("GmailAddress")).sendKeys("ChromeDriver.WebDriver");
				driver.findElement(By.name("Passwd")).sendKeys("ChromeDriver.WebDriver@gmail.com");
				WebElement PasswrodAgin=driver.findElement(By.name("PasswdAgain"));
				PasswrodAgin.sendKeys("ChromeDriver.WebDriver@gmail.com");
